      ...
      <nav className="fixed top-0 w-full z-50 backdrop-blur-xl bg-black/40 border-b border-amber-900/20">
        <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
          <h1 className="text-2xl font-bold bg-gradient-to-r from-amber-400 to-orange-500 bg-clip-text text-transparent flex items-center gap-2">
            <Coffee className="w-6 h-6 text-amber-400" /> A Epare Bangla Which Kitchen
          </h1>
      ...
      <footer className="border-t border-white/[0.06] py-10 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-lg">A Epare Bangla Which Kitchen</span>
          </div>
          ...
          <p className="text-gray-600 text-sm">© 2025 A Epare Bangla Which Kitchen. Built with <span className="text-amber-400">Heaven AI</span></p>
        </div>
      </footer>
    </main>
  );
